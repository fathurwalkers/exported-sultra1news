...
<html class="no-js" lang="zxx">
    <head>
        ...
        <meta name="description" content="{{ $artikel->artikel_judul }}">
        ...
        <meta property="og:title" content="{{ $artikel->artikel_judul }}" />
        <meta property="og:url" content="{{ url('/') }}/show/post/{{ $artikel->artikel_slug }}" />
                            ...
                            <div class="about-right mb-90">
                                ...
                                {{-- <div class="social-share pt-30">
                                    <div class="section-tittle">
                                        ...
                                        <ul>
                                            <li><a href="#"><img src="{{ asset('assets/aznews') }}/assets/img/news/icon-ins.png" alt=""></a></li>
                                            <li><a href="#"><img src="{{ asset('assets/aznews') }}/assets/img/news/icon-fb.png" alt=""></a></li>
                                            <li><a href="#"><img src="{{ asset('assets/aznews') }}/assets/img/news/icon-tw.png" alt=""></a></li>
